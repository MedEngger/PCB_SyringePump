...
const int PIN_RESET = ; //enter reset pin number
const int PIN_DC = ; //enter dc pin number
const int PIN_CS = ; //enter cs pin number
const int PIN_SCK = ; //enter sck pin number
const int PIN_MOSI = ; //enter mosi pin number

//Hardwired pins (do not change)
const int fwdPin = ;        //attached to switch S3
const int revPin = ;         //attached to switch S1
const int auxPin = ;         //attached to switch S2
const int step1 = ;          //attached to STEP+ for motor control
const int dir1 = ;           //attached to DIR+ for motor control
const int encPin1 = ;        //attached to Rotary Encoder
const int encPin2 = ;        //attached to Rotary Encoder
const int encButtonPin = ;   //attached to Rotary Encoder Switch
...
const int limitPin0 = ;      //if this pin experiences a high-low transition, motor will stop
const int limitPin1 = ;      //if this pin experiences a high-low transition, motor will stop

//mutable pins (change at will)
const int externalTriggerPin1 = ;   //a high-low transition will send stepSP1 (the p1 value) pulses to motor controller in time tMin
const int externalTriggerPin2 = ;   //a high-low transition will send stepSP2 (the p2 value) pulses to motor controller in time tMin
const int externalTriggerPin3 = ;   //a high-low transition will send stepSP3 (the p3 value) pulses to motor controller in time tMin
const int ledPin = ;                //attach LED to ground, will illuminate when motor is moving
